      ...
      <div className="auth-container fade-in-up">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <button type="submit" className="glass-btn glass-btn-primary glass-btn-lg" disabled={loading || sent} style={{ width: '100%' }}>
            {loading ? <><span className="spinner" style={{ marginRight: 8 }} />Sending...</> : sent ? <>Redirecting... <Icon icon="lucide:loader-2" style={{ marginLeft: 8 }} /></> : <>Send Reset Code <Icon icon="lucide:send" style={{ marginLeft: 8 }} /></>}
          </button>
        </form>
